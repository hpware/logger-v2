...
- Windows for deving
- BunJS
- Dokploy for deploying deployments (nixpack)
- Git
- GitHub
...
- and if the user tells you to revert, revert it.
- and finally you cost money, optimize as much requests as possible.