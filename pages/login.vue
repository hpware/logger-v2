...
<template>
  <div class="flex flex-row items-center justify-center absolute inset-0 backdrop-blur-lg w-fit max-h-fit m-auto p-8 text-white bg-gray-300/30 rounded-lg shadow-lg border border-gray-200/30">
    <form class="flex flex-col items-center p-4 space-y-3">
      ...
      <button @click.prevent="login" class="border rounded-lg p-1 bg-blue-500 px-7 hover:cursor-pointer transition-all duration-500 hover:bg-blue-500/50">Login</button>
    </form>
  </div>
</template>
